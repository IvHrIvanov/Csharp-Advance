...
namespace Parking
{
    public class StartUp
    {
        public static void Main(string[] args)
        {
            ...
            Car peugeot = new Car("Peugeot", "307", 22020);
            Car peugeo1t = new Car("Peugeot", "307", 201);
            Car peugeo21t = new Car("Peugeot", "307", 19);
            Car audi = new Car("Audi", "S4", 2005);

            parking.Add(peugeot);
            parking.Add(peugeo1t);
            parking.Add(peugeo21t);
            parking.Add(audi);
